...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='train_GT.txt',
        metainfo=dict(dataset_type='div2k', task_name='sisr'),
        data_root=data_root + '/DIV2K',
        data_prefix=dict(
            img='DIV2K_train_LR/X4', gt='DIV2K_train_HR'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(dataset_type='div2k', task_name='sisr'),
        data_root=data_root + '/DIV2K',
        data_prefix=dict(img='DIV2K_val_LR/X4', gt='DIV2K_val_HR'),
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=250_000, val_interval=250_000)
...
param_scheduler = dict(
    type='MultiStepLR',
    by_epoch=False,
    milestones=[125000, 200000, 225000, 236000],
    gamma=0.5)
